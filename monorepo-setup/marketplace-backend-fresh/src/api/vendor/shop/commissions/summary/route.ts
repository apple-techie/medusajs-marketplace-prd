...
export const GET = async (req: MedusaRequest, res: MedusaResponse) => {
  ...
  try {
    ...
    // Mock commission summary - in a real system, this would be calculated from the database
    const mockSummary = {
      total_earned: 458500, // $4,585.00
      pending_amount: 78500, // $785.00
      paid_amount: 380000, // $3,800.00
      current_month_earned: 125000, // $1,250.00
      last_month_earned: 98500, // $985.00
      average_commission_rate: 15,
      total_orders: 156,
      current_tier: 'Silver',
      tier_commission_rate: 20
    }
