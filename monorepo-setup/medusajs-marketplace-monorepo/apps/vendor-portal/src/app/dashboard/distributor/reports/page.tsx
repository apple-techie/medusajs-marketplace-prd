...
const REPORT_TYPES: ReportType[] = [
  {
    ...
    description: 'Complete breakdown of all deliveries and their status',
    icon: TruckIcon,
    available: true,
  },
  {
    ...
    description: 'On-time rates, delivery times, and efficiency metrics',
    icon: ClockIcon,
    available: true,
  },
  {
    id: 'zones',
    name: 'Zone Analysis',
    description: 'Delivery distribution across different zones and areas',
    icon: MapPinIcon,
    available: true,
  },
  {
    id: 'revenue',
    name: 'Revenue Report',
    description: 'Earnings breakdown by delivery type and zone',
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-700">
          Generate and download detailed reports for your delivery operations
        </p>
      </div>
